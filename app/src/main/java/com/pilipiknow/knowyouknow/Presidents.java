...
public class Presidents extends AppCompatActivity {
    ...
    public static Presidents.MyAppAdapter myAppAdapter;
    public static Presidents.ViewHolder viewHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       array.add(new Data("http://tokyo.philembassy.net/wp-content/uploads/2016/08/PRRD-PORTRAIT.jpg", "Rodrigo R. Duterte (2016–2022) \n" +
        ...
        myAppAdapter = new Presidents.MyAppAdapter(array, Presidents.this);
    ...
    public class MyAppAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (rowView == null) {
                ...
                viewHolder = new Presidents.ViewHolder();
                ...
                viewHolder = (Presidents.ViewHolder) convertView.getTag();
            }
            viewHolder.DataText.setText(parkingList.get(position).getDescription() + "");

            Glide.with(Presidents.this).load(parkingList.get(position).getImagePath()).into(viewHolder.cardImage);
