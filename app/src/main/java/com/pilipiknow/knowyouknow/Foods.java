...
public class Foods extends AppCompatActivity {
    ...
    public static Foods.MyAppAdapter myAppAdapter;
    public static Foods.ViewHolder viewHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        array = new ArrayList<>();
        array.add(new Data("https://panlasangpinoy.com/wp-content/uploads/2009/08/Best-Pork-Adobo-Recipe.jpg", "adobo \n" +
        ...
        array.add(new Data("https://panlasangpinoy.com/wp-content/uploads/2009/05/how-to-cook-kare-kare.jpg", "kare kare \n" +
        ...
        array.add(new Data("https://recipenijuan.com/wp-content/uploads/2017/02/Fish-Ceviche.jpg", "kinilaw  \n" +
        ...
        array.add(new Data("https://panlasangpinoy.com/wp-content/uploads/2018/11/Sinigang-na-Baboy-Recipe.jpg", "sinigang \n" +
        ...
        array.add(new Data("https://www.kawalingpinoy.com/wp-content/uploads/2017/08/sisig-1.jpg", "sisig \n" +
        ...
        array.add(new Data("https://panlasangpinoy.com/wp-content/uploads/2009/03/Pancit-Bihon-Recipe-Panlasang-Pinoy.jpg", "Letchon (1948–1953) \n" +
        ...
        array.add(new Data("https://panlasangpinoy.com/wp-content/uploads/2009/03/Pancit-Bihon-Recipe-Panlasang-Pinoy.jpg", "Pancit \n" +
        ...
        myAppAdapter = new Foods.MyAppAdapter(array, Foods.this);
    ...
    public class MyAppAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (rowView == null) {
                ...
                viewHolder = new Foods.ViewHolder();
                ...
                viewHolder = (Foods.ViewHolder) convertView.getTag();
            }
            viewHolder.DataText.setText(parkingList.get(position).getDescription() + "");

            Glide.with(Foods.this).load(parkingList.get(position).getImagePath()).into(viewHolder.cardImage);
